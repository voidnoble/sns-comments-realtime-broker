/**
 * 페이스북 판도라TV 페이지 가장 최근 라이브 영상 코멘트 로딩
 * @author yj.kwak
 * @date 2016. 11. 21
 * @description
...
const redisFacebookLastPollingAtKey = "facebook_pandoratv_last_polling_at";

class FacebookPandoratvLiveVideoComments {
    ...
    list(queryString) {
        return new Promise((resolve, reject) => {
            ...
            // API End-point = https://graph.facebook.com/v2.6/159673400728102/live_videos?access_token=
            FB.api('/v2.6/'+ this.pageId +'/live_videos', { fields: 'id,title,status,live_views' }, (res) => {
                ...
                // 영상 ID 직접 지정. ID는 영상 마우스 오른쪽 > Show video URL > 주소에서 마지막 / 이후 숫자 부분
                //video.id = '1536185453076883';
...
module.exports = new FacebookPandoratvLiveVideoComments();